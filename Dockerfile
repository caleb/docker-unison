...
&&  echo "env | grep -v HOME= > /etc/environment" >> /usr/sbin/sshd \
...
#
# Add the unison binaries
#
ADD https://github.com/caleb/unison-fsmonitor-macos/releases/download/v0.0.1/unison-2.48.4-linux-x86_64.tar.gz /
RUN tar xzf /unison-2.48.4-linux-x86_64.tar.gz -C / \
&&  rm /unison-2.48.4-linux-x86_64.tar.gz
